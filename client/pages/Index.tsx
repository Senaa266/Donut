...
const donuts = [
  {
    ...
    description: 'A tangy raspberry-glazed donut with a glossy sheen balancing sweetness with a refreshing berry zing.',
    bgColor: '#FC6297',
    glowColor: '#FF8EB5',
    buttonColor: '#FF0788',
    buttonHoverColor: '#E0066D',
    mainImage: 'https://api.builder.io/api/v1/image/assets/TEMP/fa213cb90c2c5fb2dd466bf6d80b5410557b0748?width=1600',
    thumbnail: 'https://api.builder.io/api/v1/image/assets/TEMP/b032e7a3acc7ad0983ef1327805ff4915121a1ef?width=500',
    thumbnails: [
  ...
  },
  {
    ...
    description: 'A fluffy donut infused with juicy blueberry flavor, topped with a smooth glaze and a hint of lemon zest for a bright, fruity finish.',
    bgColor: '#A664FC',
    glowColor: '#C195F9',
    buttonColor: '#AC09FE',
    buttonHoverColor: '#9108DB',
    mainImage: 'https://api.builder.io/api/v1/image/assets/TEMP/ff1602a24ca05c856bcd7b2cc1efb4000b00bbb4?width=1600',
    thumbnail: 'https://api.builder.io/api/v1/image/assets/TEMP/9d6f1146f2ede538afdb88287876a83d9c2ad367?width=500',
    thumbnails: [
  ...
  },
  {
    ...
    description: 'Rich, velvety chocolate donut coated in a dark cocoa glaze and sprinkled with chocolate flakes — pure indulgence for true cocoa lovers.',
    bgColor: '#613A13',
    glowColor: '#EEAA66',
    buttonColor: '#3A1F03',
    buttonHoverColor: '#2A1602',
    mainImage: 'https://api.builder.io/api/v1/image/assets/TEMP/eaefca3ccb88649b23f29be3180e9d68282411a7?width=1612',
    thumbnail: 'https://api.builder.io/api/v1/image/assets/TEMP/0c3716ec4ffe387303e3e2a31762da8bf7bed702?width=480',
    thumbnails: [
      'https://api.builder.io/api/v1/image/assets/TEMP/74f6645f55579267a005b6dddf092eaad7c158d5?width=300',
      ...
      <header className="px-4 sm:px-8 lg:px-12 py-6 lg:py-10">
        <div className="max-w-[1512px] mx-auto flex flex-col sm:flex-row items-center justify-between gap-6">
          ...
          <nav className="flex items-center gap-4 sm:gap-6 lg:gap-8">
            <Link to="/" className="font-inter text-base sm:text-lg lg:text-xl xl:text-2xl font-bold text-black underline">
              Home
            </Link>
            <Link to="/menu" className="font-inter text-base sm:text-lg lg:text-xl xl:text-2xl text-black hover:underline">
              Menu
            </Link>
            <Link to="/our-story" className="font-inter text-base sm:text-lg lg:text-xl xl:text-2xl text-black hover:underline">
              Our Story
            </Link>
            <Link to="/recipes" className="font-inter text-base sm:text-lg lg:text-xl xl:text-2xl text-black hover:underline">
              Recipes
            </Link>
          </nav>
          ...
          <button 
            ...
            onMouseEnter={(e) => e.currentTarget.style.backgroundColor = currentDonut.buttonHoverColor}
            onMouseLeave={(e) => e.currentTarget.style.backgroundColor = currentDonut.buttonColor}
          >
            Contact
          </button>
        </div>
                ...
                {donuts.map((donut, index) => (
                  <button
                    ...
                    className={`rounded-full transition-all hover:scale-110 ${
                      activeDonut === index ? 'ring-4 ring-white scale-110' : 'opacity-70 hover:opacity-100'
                    }`}
                  >
                    <img 
                      src={donut.thumbnail} 
